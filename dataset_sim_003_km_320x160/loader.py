...
def main():
    data_003 = dataset003.load003(filename)
    print('='*40)
    print('='*8,'dataset 003','='*8)
    print('='*40)
    print('Records count: ',len(data_003))
    print('First row: ',data_003[0])

    #split to images, values
    images, values = zip(*data_003)
    ...
    dataset003.showData(values, save_fname='full.png',show_plot=True)
    dataset003.showData(values, rng=(0,5000), save_fname='first5000.png')
