...
def main():
    data_004 = dataset004.load004(filename)
    print('='*40)
    print('='*8,'dataset 004','='*8)
    print('='*40)
    print('Records count: ',len(data_004))
    print('First row: ',data_004[0])

    #split to images, values
    images, values = zip(*data_004)
    ...
    dataset004.showData(values, save_fname='full.png',show_plot=True)
    dataset004.showData(values, rng=(0,5000), save_fname='first5000.png')
