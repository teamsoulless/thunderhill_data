...
def main():
    data_002 = dataset002.load002(filename)
    print('='*40)
    print('='*8,'dataset 002','='*8)
    print('='*40)
    print('Records count: ',len(data_002))
    print('First row: ',data_002[0])

    #split to images, values
    images, values = zip(*data_002)
    ...
    dataset002.showData(values, save_fname='full.png',show_plot=True)
    dataset002.showData(values, rng=(0,5000), save_fname='first5000.png')
